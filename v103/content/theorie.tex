...
Eine andere Methode zur Bestimmung des Elastizitätsmoduls nutzt die Schallgeschwindigkeit, da diese
in einem Festkörper in einfachem Zusammenhang mit dessen Elastizitätsmodul steht.
...
Wenn eine longitudinal Welle durch den Körper propagiert, erzeugt diese eine Spannung $\sigma (x)$.
Da das Hooksche Gesetz hier gelten muss, kann mithilfe von diesem eine Differentialgleichung aufgestellt werden,
dessen Lösungen aller Gleichungen der Form $f(x \pm ct)$ sind.
Um die Differentialgleichung zu erfüllen, muss
\begin{equation}
    c = \sqrt {\frac{E}{\rho}}
\end{equation}
gelten.
