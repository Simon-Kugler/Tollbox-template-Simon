...
from uncertainties import ufloat
#Messwerte importen
xlQ2, xrQ2, D_Q2l, D_Q2r, D_Q2Ml, D_Q2Mr, e3, e4 = np.genfromtxt("../messdaten/quadr2.txt", unpack=True)
...
#fit
params, covariance_matrix = np.polyfit(xrQ2, e4, deg=1, cov=True)
#Fehler
...
ax.plot(xrQ2, e4,"rx", label="Messdaten")
