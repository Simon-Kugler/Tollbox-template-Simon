    ...
    \begin{figure}
        \centering
        \includegraphics[height= 5cm]{Messdaten/Allgemiene_Brückenschaltung}
    ...
    \begin{figure}
        \centering
        \includegraphics[height= 5cm]{Messdaten/Induktivitätsmessung.pdf}
    ...
    \begin{figure}
        \centering
        \includegraphics[height= 5cm]{Messdaten/Wien-Robinson-Brücke.pdf}
