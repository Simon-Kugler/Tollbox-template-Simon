...
Durch hinschauen lässt sich erkennen, dass
  ...
  \end{align*}
  und Formel \ref{eq:gauss} ergibt sich für das Trägheitsmoment
  \begin{equation*}
...
\label{eq:Arme}
I_\text{A}&=m_\text{A}\left(\frac{r_\text{A}^2}{4}+\frac{(r_T \cdot0,5\cdot H_\text{A})^2}{12}\right)\,,
